...
def main():
    ...
    print("Dataset:", opts.datasetname)
    print("Perm ID:", opts.perm_id)
    print("SAM optimizer:", opts.sam_optimizer)
    print("SAM rho:", opts.rho)
    print("SAM rho_weight:", opts.rho_weight)
